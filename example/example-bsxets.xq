...
declare variable $statisticalReportTableType external := $projDir || file:dir-separator() || "include-metadata" || file:dir-separator() || "StatisticalReportTableType-EID367b8749-713d-4a6b-9a10-e37006a6d0d5.xml";
declare variable $translationTemplateBundle external := $projDir || file:dir-separator() || "include-metadata" || file:dir-separator() || "TranslationTemplateBundle-Example-EID245c67e5-6d28-493e-9dc6-a23de3d81cc0.xml";
