...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:param name="translationTemplateId">
        <xsl:message terminate="yes">Set the Translation Template Bundle EID from the generated ETS file</xsl:message>
        <xsl:value-of select="''"/>
    </xsl:param>
    ...
    <xsl:template match="/sch:schema">
        ...
        <TranslationTemplateBundle xmlns="http://www.interactive-instruments.de/etf/2.0" 
            ...
            <xsl:comment>---------------- Copied from generic Translation Template Bundle ----------------</xsl:comment>
            <!--xsl:copy-of select="document('../generic/include-metadata/TranslationTemplateBundle-EID27117afb-11aa-4e45-aa3d-0e1e65bdccb8.xml')/etf:TranslationTemplateBundle/etf:translationTemplateCollections/*"/-->
            <xsl:copy-of select="document('https://raw.githubusercontent.com/interactive-instruments/etf-ets-repository/master/generic/include-metadata/TranslationTemplateBundle-EID27117afb-11aa-4e45-aa3d-0e1e65bdccb8.xml')/etf:TranslationTemplateBundle/etf:translationTemplateCollections/*"/>
